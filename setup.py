...
RUN_DEPS = ['aiofiles', 'aiozmq', 'argparse', 'cffi', 'decorator', 'discord.py',
            'gspread-asyncio', 'ijson', 'msgpack-python', 'oauth2client',
            'pymysql', 'pyyaml', 'pyzmq', 'Sanic==0.6.0', 'SQLalchemy', 'uvloop']
